...
*/
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $urll . '',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'upload_dir' => '/admin/asset/files/upload/',
	...
	|
	*/
	'current_path' => '../../../../asset/files/upload/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../asset/files/upload/thumbs/',
